...
function test_input($data) {
    $data = trim($data); // Elimina los espacios en blanco tanto al pricipio como al final de la cadena.
    $data = stripslashes($data); // Elimina las barras invertidas añadidas previamente para escapar caracteres especiales.
    $data = htmlspecialchars($data); // Convierte caracteres especiales en entidades HTML. Esto evita código HTML o JavaScript (XSS) no deseado.
    return $data;
}
